...
type ControllerServiceDTO struct {
	...
	Properties            string                                        `json:"properties"`            // The properties of the controller service.
	Descriptors           PropertyDescriptorDTO                         `json:"descriptors"`           // The descriptors for the controller service properties.
