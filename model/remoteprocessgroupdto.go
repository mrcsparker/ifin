...
type RemoteProcessGroupDTO struct {
	...
	InputPortCount                int32                         `json:"inputPortCount"`                // The number of remote input ports currently available on the target.
	OutputPortCount               int32                         `json:"outputPortCount"`               // The number of remote output ports currently available on the target.
	ActiveRemoteInputPortCount    int32                         `json:"activeRemoteInputPortCount"`    // The number of active remote input ports.
	InactiveRemoteInputPortCount  int32                         `json:"inactiveRemoteInputPortCount"`  // The number of inactive remote input ports.
	ActiveRemoteOutputPortCount   int32                         `json:"activeRemoteOutputPortCount"`   // The number of acitve remote output ports.
	InactiveRemoteOutputPortCount int32                         `json:"inactiveRemoteOutputPortCount"` // The number of inactive remote output ports.
