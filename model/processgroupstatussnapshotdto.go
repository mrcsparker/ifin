...
type ProcessGroupStatusSnapshotDTO struct {
	...
	FlowFilesIn                       int                                      `json:"flowFilesIn"`                       // The number of FlowFiles that have come into this ProcessGroup in the last 5 minutes
	BytesIn                           int                                      `json:"bytesIn"`                           // The number of bytes that have come into this ProcessGroup in the last 5 minutes
	Input                             string                                   `json:"input"`                             // The input count/size for the process group in the last 5 minutes (pretty printed).
	FlowFilesQueued                   int                                      `json:"flowFilesQueued"`                   // The number of FlowFiles that are queued up in this ProcessGroup right now
	BytesQueued                       int                                      `json:"bytesQueued"`                       // The number of bytes that are queued up in this ProcessGroup right now
	...
	BytesRead                         int                                      `json:"bytesRead"`                         // The number of bytes read by components in this ProcessGroup in the last 5 minutes
	Read                              string                                   `json:"read"`                              // The number of bytes read in the last 5 minutes.
	BytesWritten                      int                                      `json:"bytesWritten"`                      // The number of bytes written by components in this ProcessGroup in the last 5 minutes
	Written                           string                                   `json:"written"`                           // The number of bytes written in the last 5 minutes.
	FlowFilesOut                      int                                      `json:"flowFilesOut"`                      // The number of FlowFiles transferred out of this ProcessGroup in the last 5 minutes
	BytesOut                          int                                      `json:"bytesOut"`                          // The number of bytes transferred out of this ProcessGroup in the last 5 minutes
	Output                            string                                   `json:"output"`                            // The output count/size for the process group in the last 5 minutes.
	FlowFilesTransferred              int                                      `json:"flowFilesTransferred"`              // The number of FlowFiles transferred in this ProcessGroup in the last 5 minutes
	BytesTransferred                  int                                      `json:"bytesTransferred"`                  // The number of bytes transferred in this ProcessGroup in the last 5 minutes
	...
	BytesReceived                     int                                      `json:"bytesReceived"`                     // The number of bytes received from external sources by components within this ProcessGroup in the last 5 minutes
	FlowFilesReceived                 int                                      `json:"flowFilesReceived"`                 // The number of FlowFiles received from external sources by components within this ProcessGroup in the last 5 minutes
	Received                          string                                   `json:"received"`                          // The count/size sent to the process group in the last 5 minutes.
	BytesSent                         int                                      `json:"bytesSent"`                         // The number of bytes sent to an external sink by components within this ProcessGroup in the last 5 minutes
	FlowFilesSent                     int                                      `json:"flowFilesSent"`                     // The number of FlowFiles sent to an external sink by components within this ProcessGroup in the last 5 minutes
	Sent                              string                                   `json:"sent"`                              // The count/size sent from this process group in the last 5 minutes.
	ActiveThreadCount                 int                                      `json:"activeThreadCount"`                 // The active thread count for this process group.
}
