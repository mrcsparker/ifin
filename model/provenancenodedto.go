...
ParentUuids [] `json:"parentUuids"` // The uuid of the parent flowfiles of the provenance event.
ChildUuids [] `json:"childUuids"` // The uuid of the childrent flowfiles of the provenance event.
