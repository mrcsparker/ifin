...
type ControllerServiceReferencingComponent struct {
	...
	Properties            interface{} `json:"properties"`            // The properties for the component.
	Descriptors           interface{} `json:"descriptors"`           // The descriptors for the componet properties.
	ValidationErrors      []string    `json:"validationErrors"`      // The validation errors for the component.
	ReferenceType         string      `json:"referenceType"`         // The type of reference this is. Allowable values: Processor, ControllerService, or ReportingTask
