...
Relationships []RelationshipDTO `json:"relationships"` // The available relationships that the processor currently supports.
...
ValidationErrors [] `json:"validationErrors"` // The validation errors for the processor. These validation errors represent the problems with the processor that must be resolved before it can be started.
}
